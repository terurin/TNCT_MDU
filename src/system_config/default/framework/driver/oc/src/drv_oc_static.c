...
{	
    /* Setup OC0 Instance */
    PLIB_OC_ModeSelect(OC_ID_1, OC_SET_HIGH_SINGLE_PULSE_MODE);
    ...
    PLIB_OC_PulseWidth16BitSet(OC_ID_1, 12);
}
...
{	
    ...
    PLIB_OC_PulseWidth16BitSet(OC_ID_2, 12);
}
...
{	
    ...
    PLIB_OC_PulseWidth16BitSet(OC_ID_3, 12);
}
...
{	
    ...
    PLIB_OC_PulseWidth16BitSet(OC_ID_4, 12);
}
